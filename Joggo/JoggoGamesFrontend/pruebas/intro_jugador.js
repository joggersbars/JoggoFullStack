// Función para obtener el parámetro "id_partida" de la URL --> caso de entrar desde el QR
function getIdPartidaFromURL() {
    const urlParams = new URLSearchParams(window.location.search);
    return urlParams.get("id_partida"); // Obtenemos el valor de id_partida que viene como parámetro desde la URL
}
